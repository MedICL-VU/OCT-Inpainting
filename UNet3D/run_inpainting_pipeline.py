...
# def split_volumes(triplets, train_fraction=0.8):
#     """
#     Splits triplets into train/test
#     """
#     n = len(triplets)
#     n_train = int(n * train_fraction)
#     train = triplets[:n_train]
#     test = triplets[n_train:]
#     return train, test
...
def main():
    ...
    # train_dataset = OCTAInpaintingDataset(corrupted_path, clean_path, mask_path, stack_size=stack_size)
    ...
    # train_vols, test_vols = split_volumes(volume_triplets, train_fraction=0.8)
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        # val_loss = validate_epoch(model, train_loader, criterion)
    ...
    log("Inpainting held-out test volume...")
